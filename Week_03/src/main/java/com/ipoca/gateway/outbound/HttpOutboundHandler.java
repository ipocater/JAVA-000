package com.ipoca.gateway.outbound;
...
public class HttpOutboundHandler {
    ...
    public HttpOutboundHandler(String backendUrl){
        ...
        proxyServer = new ThreadPoolExecutor(cores, cores,
    ...
    public void handler(final FullHttpRequest fullRequest, final ChannelHandlerContext ctx){
        ...
        proxyServer.submit(()->fetchGet(fullRequest, ctx, url));
    }
    ...
    private void fetchGet(final FullHttpRequest inbound, ChannelHandlerContext ctx, String url) {
        ...
        httpclient.execute(httpGet, new FutureCallback<HttpResponse>() {
            ...
            public void completed(final HttpResponse endpointResponse) {
                try {
                    handlerResponse(inbound, ctx, endpointResponse);
                } catch (Exception e){
                    e.printStackTrace();
                } finally {
    ...
    private void handlerResponse(final FullHttpRequest fullRequest, ChannelHandlerContext ctx, HttpResponse endpointResponse) {
